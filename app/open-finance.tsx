    ...
    async function boot() {
      ...
      try {
        ...
        if (!providerStatus.enabled || !providerStatus.configured) {
          setMessage('Open Finance está em homologação e ainda não está disponível neste ambiente.');
          return;
        }
      ...
      if (nextStatus === 'credited') {
        ...
        setMessage(
          ledgerCreditEnabled
            ...
            : 'Pagamento confirmado na homologação. O crédito no saldo continua desligado por segurança.',
        );
      ...
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        ...
        {!config.efiOpenFinanceEnabled || !backendReady ? (
          <View style={styles.card}>
            <Text style={styles.cardTitle}>Em homologação</Text>
            <Text style={styles.cardText}>
              A integração está preparada, mas permanece bloqueada até a validação da Efí e da Nexa.
            </Text>
          </View>
        ) : (
          <>
